...
Writes (only if allowed): create/update/move/copy/rename/delete_item. update changes only the fields you pass. copy_item copies field DATA, not just structure. delete_item recycles by default; permanent=true destroys irreversibly.
